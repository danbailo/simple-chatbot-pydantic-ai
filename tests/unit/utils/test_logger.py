...
from simple_chatbot_pydantic_ai.utils.logger import (
    Logger,
    LoggerFactory,
    LoggerNameEnum,
)
...
@patch('simple_chatbot_pydantic_ai.utils.logger.getenv')
@patch(
    'simple_chatbot_pydantic_ai.utils.logger.LoggerFactory.is_configured', lambda: False
)
@patch('simple_chatbot_pydantic_ai.utils.logger.LoggerFactory._logger_name', None)
@patch('simple_chatbot_pydantic_ai.utils.logger.LoggerFactory._logger_renderers', [])
@patch('simple_chatbot_pydantic_ai.utils.logger.LoggerFactory._logger_configs', None)
@patch('simple_chatbot_pydantic_ai.utils.logger.LoggerFactory._logger_level', None)
@patch('simple_chatbot_pydantic_ai.utils.logger.LoggerFactory._is_local', None)
